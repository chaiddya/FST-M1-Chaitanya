...
SELECT salesman_id FROM orders DISTINCT;

SELECT DISTINCT salesman_id FROM orders;

SELECT order_no, order_date FROM orders ORDERBY order_date;

SELECT order_no, order_date FROM orders ORDER BY order_date;

SELECT order_no, purchase_amount FROM orders ORDER BY purchase_amount DESC;

SELECT * FROM ordres WHERE purchase_amount <500;

SELECT * FROM orders WHERE purchase_amount <500;

SELECT * FROM orders WHERE purchase_amount BETWEEN 1000 AND 2000;

SELECT SUM(purchase_amount) AS "TOTAL PURCHASE SUM" FROM orders;
...
SELECT salesman_id; order_date, MAX(purchase_amount) AS "HIGHEST SALE" FROM orders WHERE order_date=TO_DATE('2012-08-17','YYYY-MM-DD') GROUP BY salesman_id, order_date;
